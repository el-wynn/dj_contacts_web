...
export async function GET(request: NextRequest) {
    ...
    console.log('SPOT: Access token found:', accessToken ? 'Exists' : 'Does not exist');
    //console.log('SPOT: Refresh token found:', refreshToken ? 'Exists' : 'Does not exist');
    ...
    if (accessToken) {
        console.log('SPOT: Access token exists. User is authenticated.');
    ...
    console.log('SPOT: Neither access nor refresh token found. User is not authenticated.');
