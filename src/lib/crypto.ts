...
export function encrypt(data : string, key : string) { // Function to encrypt data
    ...
    const cipher = crypto.createCipheriv(algorithm, Buffer.from(key), crypto.randomBytes(16));
...
export function decrypt(data : Encrypt, key : string) { // Function to decrypt data
