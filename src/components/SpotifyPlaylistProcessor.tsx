			...
			{stage === 'artists' && (
				<div className="space-y-4">
					<button
						...
						className="rounded-lg px-3 py-2 bg-gray-50 hover:bg-gray-200 text-gray-700 text-sm font-medium mb-3 cursor-pointer shadow-sm"
					>
						&lt; Back
					</button>

					{isError ? (
						<div className="mt-4 p-3 text-yellow-800 bg-yellow-50 border border-yellow-200 rounded-lg shadow-sm">
							{artists}
						</div>
					) : (
						<div className="space-y-2 shadow-sm bg-gray-200 border-gray-100 rounded-xl p-2">
							<h3 className="text-sm text-gray-700">Artists in this playlist:</h3>
							<textarea
								value={artists}
								readOnly
